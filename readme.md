...
| Name | Description |
| ---- | ----------- |
| [ADCHS DMA](apps/adchs/adchs_dma/readme.md) | This example application shows how to sample an analog input using the ADCHS peripheral in DMA mode and displays the converted samples on a serial terminal |
...
| [DAC waveform generation](apps/cdac/cdac_wav_gen/readme.md) | This example application shows how to use the CDAC to generate a 1 KHz sinusoidal waveform |
| [DAC waveform generation with DMA](apps/cdac/cdac_wav_gen_dma/readme.md) | This example application shows how to use the CDAC with the DMA to generate a 1 KHz sinusoidal waveform without CPU intervention |
